...
def ask_ai(user_text, conversation_history=None):
    ...
    system_prompt = (
        ...
        "Wallet System ရှိပါတယ် - 💳 My Wallet နှိပ်ပြီး Ngwe ကြိုဖြည့်နိုင်ပါသည်။ "
...
async def buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ─────────── WALLET MENU ───────────
        ...
        kb = [
            [InlineKeyboardButton("➕ Ngwe ဖြည့်မည် (Top-up)", callback_data="wallet_topup")],
        ...
        payment_text = (
            ...
            f"{PAYMENT_INFO}\n\n"
            f"📸 ပြေစာ ဓာတ်ပုံ ပို့ပြီးပါက Admin မှ စစ်ပြီး Ngwe ဖြည့်ပေးပါမည်"
        )
    ...
    # ─────────── PAYMENT METHOD CHOICE HANDLER ───────────
        ...
        await q.edit_message_text(
            text=f"{PAYMENT_INFO}\n\n⚠️ Ngwe လွှဲပြေစာ ဓာတ်ပုံကို ယခု Chat သို့ ပို့ပေးပါခင်ဗျာ။",
            parse_mode="HTML"
        )
    ...
    # ─────────── WALLET PAY (from order flow) ───────────
        ...
        if balance < price:
            ...
            await q.message.reply_text(
                ...
                f"💡 ဝယ်ယူရန်အတွက် ကျေးဇူးပြု၍ Wallet ထဲသို့ Ngwe ဖြည့်ပေးပါခင်ဗျာ။",
                parse_mode="HTML",
                reply_markup=InlineKeyboardMarkup(kb)
            )
            return
        ...
        await q.message.reply_text(
            ...
            f"💵 ကျသင့်ငွေ: <b>{price:,} ks</b>\n"
            f"👤 သင်၏ လက်ရှိလက်ကျန်ငွေ: <b>{balance:,} ks</b>\n\n"
            f"⚠️ <i>ဤအဆင့်ပြီးပါက Wallet ထဲမှ Ngwe အား တိုက်ရိုက်နှုတ်ယူသွားမည်ဖြစ်ပါသည်။</i>\n\n"
